...
def tlsf_gen_unreal_1(k):
    filename = 'Dataset_seeds/scalable-benchmarks/unreal_1/unreal_scalable_1_'+str('{0:03}'.format(k+1))+'.tlsf'
    out = open(filename, 'w')
    # 'print INFO'
    print('INFO {', file=out)
...
def tlsf_gen_unreal_1_env(k):
    filename = 'Dataset_seeds/scalable-benchmarks/unreal_1/unreal_scalable_1_'+str('{0:03}'.format(k+1))+'.Xtlsf'
    out = open(filename, 'w')
    # 'print INFO'
    print('INFO {', file=out)
    print('TITLE:       \"Scalable Unrealizable Benchmark n.'+str(k)+ '\"', file=out)
...
def main(argv):
    ...
    save_tlsf = Path("Dataset_seeds/scalable-benchmarks/unreal_1")
    save_tlsf.mkdir(parents=True, exist_ok=True)

    # save_tlsf_env = Path("Dataset_seeds/scalable-benchmarks/env/unreal_1")
